      ...
      <?php
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><li style="margin-left:10px"><?php  echo $email;?></li>
             <li role="separator" class="divider">
            <li><li style="margin-left:10px"><?php  echo $mob;?></li></li>
             <li role="separator" class="divider">
            <li><li style="margin-left:10px"><?php  echo $gen;?></li></li>
             <li role="separator" class="divider">
            <li><li style="margin-left:10px"><?php  echo $city;?></li></li>
