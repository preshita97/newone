  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php
			...
			$obj=new database();
			$res=$obj->viewwish($email_id,$flag);
			$cnt=mysql_num_rows($res);
			
		
			?>
			<li style="margin-left:10px;"><a href="kart.php" class="btn btn-danger" role="Button"> <span class="glyphicon glyphicon-heart" aria-hidden="true" style="color:white"></span><?php echo '<span class="badge" style="font-size:8px;margin-top:-12px;margin-left:-5px;background:yellow">'.$cnt.'</span>'; ?></a></li>
